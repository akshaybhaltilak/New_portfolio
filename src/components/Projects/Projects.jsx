    ...
    const projects = [
        {
            ...
            Technologies: ['HTML', 'REACT Js', 'EJS', 'JavaScript', 'Node Js', 'PostgreSQL', 'REST API', 'Github'],
            category: 'Education',
        ...
        },
        {
            ...
            description: 'Realtime Chat Application For Comunication.',
            ...
            live_link: 'https://chating-nfl1.vercel.app/',
            featured: false,
            completion: 75,
        },
        {
            title: 'Brocode',
            description: 'A social media platfrom for students.',
            ...
            live_link: 'https://bbrocode.netlify.app/',
            featured: true,
            completion: 80,
        },
    ];
